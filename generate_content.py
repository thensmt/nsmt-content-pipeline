...
from style_guide import (
    ...
    AI_TELLS_AVOIDANCE,
    GUARDRAILS,
    SOURCE_HIERARCHY_RULE as _SOURCE_HIERARCHY_RULE,
)
...
# GUARDRAILS now lives in style_guide.py (single source of truth) and is
# imported at the top of this module. The Mystics LLM writer
# (newsroom/llm_writer.py) imports the same constant. The baselines path still
# uses generate_baselines._BASELINE_GUARDRAILS (paraphrased for season-feature
# framing); changes to the shared text should be reflected there when relevant.
...
# _SOURCE_HIERARCHY_RULE is imported at the top from style_guide.SOURCE_HIERARCHY_RULE.
