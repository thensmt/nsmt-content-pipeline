...
const WRITERS = [
  ...
  { id: "frost",      name: "Ada Frost",        first: "Ada",       last: "Frost",      team: "Washington Capitals",   league: "NHL",     sport: "Hockey",     color: "#A6192E", color2: "#041E42", initials: "AF", tier: "PRO",
    ...
    status: "published" },
  { id: "cooper",     name: "Bayes Cooper",     first: "Bayes",     last: "Cooper",     team: "Washington Nationals",  league: "MLB",     sport: "Baseball",   color: "#AB0003", color2: "#14225A", initials: "BC", tier: "PRO",
    ...
    headline: "Cooper: Nats' Bullpen Holds, City Connect Jerseys Win Again",
    status: "scheduled" },
  ...
  { id: "lane",       name: "Terry Lane",       first: "Terry",     last: "Lane",       team: "Maryland Terrapins",     league: "Big Ten",   sport: "Basketball", color: "#E03A3E", color2: "#FFD520", initials: "TL", tier: "COLLEGE",
    ...
    status: "drafting" },
  { id: "mitchell",   name: "Cav Mitchell",     first: "Cav",       last: "Mitchell",   team: "Virginia Cavaliers",     league: "ACC",       sport: "Basketball", color: "#232D4B", color2: "#F84C1E", initials: "CM", tier: "COLLEGE",
    ...
    headline: "Mitchell: Cavaliers' Pack-Line Strangles Duke, 61-54 at JPJ",
    status: "idle" },
  { id: "bremner",    name: "Hayes Bremner",    first: "Hayes",     last: "Bremner",    team: "Virginia Tech Hokies",   league: "ACC",       sport: "Basketball", color: "#630031", color2: "#CF4420", initials: "HB", tier: "COLLEGE",
    ...
    status: "reviewing" },
  { id: "hoya",       name: "Vance Hoya",       first: "Vance",     last: "Hoya",       team: "Georgetown Hoyas",       league: "Big East",  sport: "Basketball", color: "#041E42", color2: "#8D817B", initials: "VH", tier: "COLLEGE",
    voice: "Prestige tone. Big East tradition. Hoya Saxa, always.",
    pull: "Prestige tone. Big East tradition. Hoya Saxa.",
    headline: "Hoya: Hoyas Hand Villanova First Big East Loss of the Year",
    status: "published" },
  { id: "adams",      name: "Mason Adams",      first: "Mason",     last: "Adams",      team: "George Mason Patriots",  league: "A-10",      sport: "Basketball (M/W)", color: "#006633", color2: "#FFCC33", initials: "MA", tier: "COLLEGE",
    ...
    status: "idle" },
  { id: "reed",       name: "Eagle Reed",       first: "Eagle",     last: "Reed",       team: "Mary Washington Eagles", league: "NCAA D-III", sport: "Basketball", color: "#003366", color2: "#A0A0A0", initials: "ER", tier: "COLLEGE",
    ...
    headline: "Reed: Eagles Stretch CAC Win Streak to Eleven, Top Salisbury",
    status: "idle" },
];
