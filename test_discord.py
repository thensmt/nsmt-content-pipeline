...
NOTE: side-effect code is guarded by `if __name__ == "__main__":` so that
`unittest discover` can safely import this module without firing a live
Discord post or exiting the test run.
"""
